            ...
            <Grid container spacing={4} justifyContent="center" px={4}>
              ...
              <Grid item xs={12} md={4}>
                ...
                <Stack direction="row" spacing={2}>
                  ...
                  <Link href="https://www.linkedin.com/company/asppibra-dao/" target="_blank" rel="noopener noreferrer">
                    <LinkedInIcon sx={{ color: "white" }} />
                  </Link>
                  <Link href="https://www.instagram.com/asppibra" target="_blank" rel="noopener noreferrer">
                  ...
                  <Link href="https://chat.whatsapp.com/FF6cs4zKS6BGxhLOyaNgu1" target="_blank" rel="noopener noreferrer">
