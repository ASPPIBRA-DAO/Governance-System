...
const timelineData: TimelineItemData[] = [
  {
    ...
    year: "2025",
    color: "#00eaff",
    title: "Infraestrutura Digital Rural",
    text: "Implementação de conectividade e plataformas digitais para apoiar agricultores familiares.",
  },
  {
    id: 2,
    year: "2026",
    color: "#00ff95",
    title: "Monitoramento Agroecológico Inteligente",
    text: "Sensores e IA para monitoramento de solo, clima e biodiversidade nos assentamentos.",
  },
  {
    id: 3,
    year: "2027",
    color: "#f5ff3d",
    title: "Academia Agro Digital",
    text: "Capacitação em inclusão digital, agroecologia e tecnologias abertas.",
  },
  {
    id: 4,
    year: "2028",
    color: "#ff8c00",
    title: "Plataforma de Planejamento da Produção",
    text: "Ferramentas de previsão de safra, logística e integração com mercados locais.",
  },
  {
    id: 5,
    year: "2029",
    color: "#bb5bff",
    title: "Cooperativas Digitais Inteligentes",
    text: "Automação cooperativa com IA para governança e distribuição de renda.",
  },
  {
    id: 6,
    year: "2030",
    color: "#00c9ff",
    title: "Ecossistema Agroecológico Autônomo",
    text: "IA, dados comunitários e agroecologia integrados para sistemas sustentáveis.",
  },
];
      ...
      <Container>
        <MDBox textAlign="center" maxWidth="48rem" mx="auto" mb={10}>
          <MDTypography
            variant="h2"
            fontWeight="bold"
            sx={{ filter: "drop-shadow(0 0 12px #00eaff)" }}
          >
            Ultimas Noticias
          </MDTypography>
          <MDTypography variant="h5" color="text" mt={2} sx={{ opacity: 0.8 }}></MDTypography>
        </MDBox>
